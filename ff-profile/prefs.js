...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1786584705);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1786584705);
user_pref("app.update.lastUpdateTime.glean-addons-daily", 1786584705);
user_pref("app.update.lastUpdateTime.region-update-timer", 1786584705);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1786584676);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1786584705);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1786584705);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{1a0f6c1f-a6f9-42a4-a647-85a25c1f63d3}");
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1786584675628");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1786606275628");
user_pref("browser.search.update", false);
user_pref("browser.sessionstore.resume_from_crash", false);
user_pref("browser.shell.checkDefaultBrowser", false);
user_pref("browser.startup.couldRestoreSession.count", -1);
user_pref("browser.startup.homepage_override.mstone", "ignore");
user_pref("browser.startup.lastColdStartupCheck", 1786584676);
...
user_pref("captchadetection.lastSubmission", 1786584);
...
user_pref("extensions.webextensions.uuids", "{\"data-leak-blocker@mozilla.com\":\"e54c829d-1bd6-4fb6-b5fd-729e6e3eaae7\",\"formautofill@mozilla.org\":\"24b63960-4df2-4532-887b-926c4788e1d1\",\"ipp-activator@mozilla.com\":\"cfe7d80e-4c92-49c2-9f5d-2df62cd50e83\",\"pictureinpicture@mozilla.org\":\"23588454-f20b-496b-8df9-79d1201a70d9\",\"addons-search-detection@mozilla.com\":\"a91a8bd3-f418-4751-8b40-5005872335f1\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"jid1-TSgSxBhncsPBWQ@jetpack\":\"6d316b4c-c2d2-4059-bf22-e0d6e4f81f16\",\"newtab@mozilla.org\":\"44cece7a-e950-4575-b404-def5eefb6f68\",\"uBlock0@raymondhill.net\":\"90890186-f906-4fb2-af05-b4ec389f9e8a\",\"uanaughtylist@raspberrypi.com\":\"54be5eb0-1f96-4d6b-b709-3d4e5091c428\",\"default-theme@mozilla.org\":\"c80a8f32-ee29-4b1d-a4f1-6768b40db5d2\"}");
...
user_pref("idle.lastDailyNotification", 1786584854);
...
user_pref("media.gmp-gmpopenh264.lastDownload", 1786584696);
user_pref("media.gmp-gmpopenh264.lastInstallStart", 1786584695);
user_pref("media.gmp-gmpopenh264.lastUpdate", 1786584696);
user_pref("media.gmp-gmpopenh264.version", "2.6.0");
user_pref("media.gmp-manager.buildID", "20260601110758");
user_pref("media.gmp-manager.lastCheck", 1786584695);
...
user_pref("nimbus.profileId", "2a9c681c-835a-4aa2-a857-56059d82fde4");
user_pref("pdfjs.enabledCache.state", true);
user_pref("pdfjs.migrationVersion", 2);
user_pref("permissions.isolateBy.userContext", true);
user_pref("places.database.lastMaintenance", 1786584854);
user_pref("privacy.bounceTrackingProtection.hasMigratedUserActivationData", true);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1786584854291");
...
user_pref("storage.vacuum.last.places.sqlite", 1786584854);
user_pref("telemetry.fog.test.localhost_port", -1);
user_pref("termsofuse.bypassNotification", true);
user_pref("toolkit.profiles.storeID", "f84a7088");
user_pref("toolkit.startup.last_success", 1786584673);
